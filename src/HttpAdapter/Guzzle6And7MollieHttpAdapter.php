...
use _PhpScoperf859eabf1411\Composer\CaBundle\CaBundle;
use _PhpScoperf859eabf1411\GuzzleHttp\Client;
use _PhpScoperf859eabf1411\GuzzleHttp\ClientInterface;
use _PhpScoperf859eabf1411\GuzzleHttp\Exception\GuzzleException;
use _PhpScoperf859eabf1411\GuzzleHttp\HandlerStack;
use _PhpScoperf859eabf1411\GuzzleHttp\Psr7\Request;
use _PhpScoperf859eabf1411\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
use Mollie\Api\Exceptions\ApiException;
use _PhpScoperf859eabf1411\Psr\Http\Message\ResponseInterface;
final class Guzzle6And7MollieHttpAdapter implements \Mollie\Api\HttpAdapter\MollieHttpAdapterInterface
{
    ...
    public function __construct(\_PhpScoperf859eabf1411\GuzzleHttp\ClientInterface $httpClient)
    {
    ...
    public static function createDefault()
    {
        ...
        $handlerStack = \_PhpScoperf859eabf1411\GuzzleHttp\HandlerStack::create();
        $handlerStack->push($retryMiddlewareFactory->retry());
        $client = new \_PhpScoperf859eabf1411\GuzzleHttp\Client([\_PhpScoperf859eabf1411\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoperf859eabf1411\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoperf859eabf1411\GuzzleHttp\RequestOptions::TIMEOUT => self::DEFAULT_TIMEOUT, \_PhpScoperf859eabf1411\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::DEFAULT_CONNECT_TIMEOUT, 'handler' => $handlerStack]);
    ...
    {
        $request = new \_PhpScoperf859eabf1411\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoperf859eabf1411\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoperf859eabf1411\Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function versionString()
    {
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            return "Guzzle/" . \_PhpScoperf859eabf1411\GuzzleHttp\ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            return "Guzzle/" . \_PhpScoperf859eabf1411\GuzzleHttp\ClientInterface::VERSION;
        }
        return null;
    }
}
